...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.position_lr_init = 0.00032
        self.position_lr_final = 0.0000032
        ...
        self.start_blurring = 1500
        self.start_weight = 1500
        ...
        # MLP & rendering
        self.kernel_lr_init = 1e-3
        self.kernel_lr_final = 1e-5
        self.hidden = 3
        self.width = 64
        self.num_coc_gaussians = 4
